...
// ROUTE 1: Create a User using: POST "/api/auth/createuser". No login requied
...
router.post('/login', [
    ...
    try {
        ...
        // If password matches return the data
        const data = {
            user: {
                id: user.id
            }
...
// ROUTE 3: Get logged in User Details using: POST "/api/auth/getuser". Auth Token requied 
